...
public class AlbumController {
    ...
    @GetMapping("/album/{id}")
    public Album getAlbumById(@PathVariable long id){return albumService.getAlbumById(id);}

    @PostMapping("/album")
    public Album createAlbum(@RequestBody Album album){return albumService.createAlbum(album);}
    ...
    public void deleteAlbumById(@PathVariable long id){albumService.deleteAlbumById(id);}
}
